...
function M.setup()
  ...
  if ok then
    ...
    vim.api.nvim_set_hl(0, "StreamlineRecordingOn", { fg = rose_pine.love, bg = rose_pine.overlay })
    vim.api.nvim_set_hl(0, "StreamlineRecordingOff", { fg = rose_pine.base, bg = rose_pine.overlay })
